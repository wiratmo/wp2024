                                        ...
                                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                            ...
                                            <td class="p-4 space-x-2 whitespace-nowrap">
                                                ...
                                                @elseif ($industry->is_verify == 0)
                                                    <div class="p-4 text-base font-normal text-gray-900 whitespace-nowrap dark:text-white">
                                                        <div class="flex items-center">
                                                            <div class="mr-2 h-2.5 w-2.5 rounded-full bg-red-500"></div> Menunggu
                                                        </div>
                                                    </div>
                                                @else
                                                    <button x-data @click="$dispatch('open-modal',{name:'request'})"
                                                        wire:click="$dispatch('open-request', { id: {{ $industry->id }} })" type="button"
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <form action="{{ route("download-permohonan") }}" method="POST">
                                                    @csrf
                                                    <input type="hidden" name="industryId" value="{{ $request->first()->industry_id }}">
                                                    <button type="submit" class="flex items-center p-2 text-sm italic ">
